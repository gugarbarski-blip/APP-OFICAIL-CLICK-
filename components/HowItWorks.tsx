...
const steps = [
  ...
  },
  {
    icon: Palette,
    title: 'Personalize',
    description: 'Escolha o tipo de gravação e faça upload da sua arte ou logo.',
    color: 'bg-primary',
  },
  {
    icon: CreditCard,
  ...
  {
    icon: Package,
    title: 'Receba seu Brinde',
    description: 'Entregamos em todo o Brasil com prazo garantido.',
    color: 'bg-green-500',
  },
];
