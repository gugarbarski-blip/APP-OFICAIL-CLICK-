...
export const WhyChooseUs: React.FC = () => (
  <section id="diferenciais" className="py-20 bg-[#1a1917]">
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {differentials.map(item => {
          ...
          return (
            <div key={item.title} className="group p-6 rounded-2xl border border-white/8 bg-[#2a2825] hover:border-[#D4AF37]/40 hover:bg-[#2e2b27] transition-all">
