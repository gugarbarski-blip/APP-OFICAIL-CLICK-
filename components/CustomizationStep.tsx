...
import { Customization, CustomizationType, PRODUCT, calcUnitPrice } from '../types';
...
export const CustomizationStep: React.FC<CustomizationStepProps> = ({ value, onChange, onBack, onNext }) => {
  ...
  return (
    <div className="min-h-screen pt-16 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <h2 className="font-poppins text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Personalize seu Copo</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className={`text-xs mt-2 font-medium ${selected ? 'text-primary' : 'text-gray-400'}`}>
                        R$ {calcUnitPrice(key).toFixed(2).replace('.', ',')} / un.
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <ArtPreviewCanvas artUrl={value.artPreviewUrl} />
            {value.artPreviewUrl && (
