    ...
    const animate = () => {
      ...
      for (let x = 0; x < width; x += 2) {
        for (let y = 0; y < height; y += 2) {
          ...
          // Cor seda dourada/bronze para combinar com o tema ImpreBrindes
          const r = Math.floor(180 * intensity);
          const g = Math.floor(150 * intensity);
          const b = Math.floor(80 * intensity);
      ...
      overlayGradient.addColorStop(1, 'rgba(0, 0, 0, 0.55)');
