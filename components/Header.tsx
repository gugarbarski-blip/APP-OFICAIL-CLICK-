...
export const Header: React.FC<HeaderProps> = ({ onCtaClick, onMeusPedidos, onMinhaContaClick }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#1a1917]/95 backdrop-blur-md shadow-md border-b border-white/10' : 'bg-transparent'}`}>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-[#1a1917] border-t border-white/10 px-4 pb-4">
